...
class User(Base):
    ...
    calendar_tokens: Mapped[list[CalendarToken]] = relationship(
        "CalendarToken", back_populates="user", cascade="all, delete-orphan"
    )
    reset_tokens: Mapped[list[PasswordResetToken]] = relationship(
        "PasswordResetToken", back_populates="user", cascade="all, delete-orphan"
    )
    verify_tokens: Mapped[list[EmailVerificationToken]] = relationship(
...
class Note(Base):
    ...
    tasks: Mapped[list[NoteTask]] = relationship(
        "NoteTask", back_populates="note", cascade="all, delete-orphan"
    )
...
class NoteSummary(Base):
    ...
    note_id: Mapped[str] = mapped_column(
        ForeignKey("notes.id"), nullable=False, unique=True
    )
    user_id: Mapped[str] = mapped_column(ForeignKey("users.id"), nullable=False)
